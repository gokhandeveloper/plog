(ns gokhan-website.routes
  ...
  (:require [compojure.core :refer :all]
            ...
            [gokhan-website.interactors.product-page :as product-page]
            [gokhan-website.interactors.recommended-books :as recommended-books]
            [gokhan-website.interactors.notification-registration :as register]
            [gokhan-website.interactors.user-groups :as user-groups]
            [gokhan-website.interactors.about-me :as about-me]
            [gokhan-website.interactors.contact :as contact]
...
(defroutes
  ...
  (GET "/about" [] (about-me/exec))
  (GET "/contact" [] (contact/exec))
 (GET "/not-found" [] (contact/exec))
  (route/resources "/")
